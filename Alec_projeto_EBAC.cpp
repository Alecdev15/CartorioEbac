...
int registro () //Função responsável por cadastrar os usuários no sistema
{
	...
	strcpy(arquivo, cpf); //Responsável por copior os valores da string
	
	FILE *file; //cria o arquivo
	file = fopen(arquivo,"w"); //cria o arquivo e "w" escreve o arquivo
...
int consulta()
{
	setlocale(LC_ALL, "Portuguese"); //Definindo a linguagem para acentuações
...
int deletar()
{
	...
	printf("Você optou por remover um funcionário!\n");
    scanf("%s", cpf);
    ...
    if(file == NULL)
    {
    	printf("O funcionário não se encontra no sistema!.\n");
    	system("pause");
	}
}
